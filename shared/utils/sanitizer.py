"""
Shared PII sanitizer. Used by all PoC backends.
To import: add the project root to PYTHONPATH, then `from shared.utils.sanitizer import Sanitizer`.
PoC backends carry a local copy in services/sanitizer.py until a proper editable install is set up.
"""
import re
